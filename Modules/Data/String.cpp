...
nXD::Result 
String::fn_Concat(const String& _str) {
...
int 
String::fn_Find(const String& _substr) const {
...
nXD::Result 
String::fn_Replace(char _oldChar, char _newChar) {
...
size_t 
String::fn_Length() const {
    return Var_Length;
}

char 
String::fn_CharAt(int _index) const {
...
bool 
String::fn_Equals(const String& _str) const 
{
    return strcmp(Var_Data, _str.Var_Data) == 0;
}

const char* 
String::fn_CStr() const 
{
    return Var_Data;
}
