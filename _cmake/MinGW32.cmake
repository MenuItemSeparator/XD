# CMake Toolchain for MinGW 32-bit
# Usage: cmake -DCMAKE_TOOLCHAIN_FILE=_cmake/MinGW32.cmake ..
...
set(CMAKE_C_FLAGS "-m32" CACHE STRING "C compiler flags")
set(CMAKE_CXX_FLAGS "-m32" CACHE STRING "C++ compiler flags")

# Linker flags
set(CMAKE_EXE_LINKER_FLAGS "-m32 -static" CACHE STRING "Linker flags for executables")
set(CMAKE_SHARED_LINKER_FLAGS "-m32" CACHE STRING "Linker flags for shared libraries")
set(CMAKE_MODULE_LINKER_FLAGS "-m32" CACHE STRING "Linker flags for modules")
